...
![Windows File Explorer showing the project folder](/images/2024/windows-file-explorer-gcp-functions.png)
...
![A terminal window executing the deploy script](/images/2024/windows-terminal-gcp-functions-deploy.png)
