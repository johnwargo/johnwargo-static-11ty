...
![Android Studio warning](/images/2024/flutter-app-upgrade-1.png)
...
![Android Studio error](/images/2024/flutter-app-upgrade-2.png)

The easiest way to address all of the issues like this in your code is to use the **Dart Analysis** tool shown below:

![Android Studio Dart Analysis tool](/images/2024/flutter-app-upgrade-3.png)
