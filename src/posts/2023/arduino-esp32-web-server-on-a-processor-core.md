...
I always wanted to redo this project, especially using some of the smaller ESP32 devices like the [Seeed Studio Xiao](https://seeedstudio.com/xiao-series-page){target="_blank"} series of microcontrollers and some of the smaller NeoPixel matrixes like the [Adafruit 5x5 NeoPixel Grid BFF Add-On for QT Py and Xiao](https://adafruit.com/product/5646){target="_blank"}. Because of this, I recently published a refresh in [Glowing Pumpkin Xiao 5x5 BFF](https://github.com/johnwargo/glowing-pumpkin-xiao-bff){target="_blank"}. 
...
![windows terminal showing the results of the ping command](/images/2023/ping-pumpkin-local.png)
...
For this project, I built the [Pumpkin LED Controller](https://github.com/johnwargo/pumpkin-led-controller-html){target="_blank"} application, then published it using [Netlify](https://netlify.com/){target="_blank"}. Netlify allows you to publish web apps for free if they're Open Source projects as this one is. They even give you a secure URL to access the web app from (without having to buy a custom domain); in this case its [https://pumpkin-controller.netlify.app/](https://pumpkin-controller.netlify.app/){target="_blank"}.
...
![The project's redirect web page running in the browser](/images/2023/pumpkin-controller-redirect-page.png)
...
![A diagram illustrating how the project redirects a browser request](/images/2023/pumpkin-controller-redirect.png)
...
![An error message rendering in a browser window](/images/2023/pumpkin-controller-not-found.png)
