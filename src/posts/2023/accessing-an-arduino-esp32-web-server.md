...
![Postman GET command to set color](/images/2023/pmpkn-crtl-postman-01.png)
...
![Postman GET command Using DNS Name](/images/2023/pmpkn-crtl-postman-02.png)
...
![Postman Save Request Dialog](/images/2023/pmpkn-crtl-postman-03.png)
...
![Pumpkin Controller web app running in a browser locally](/images/2023/pumpkin-controller-browser-local.png)
...
![Pumpkin Controller web app hosted remotely](/images/2023/pumpkin-controller-browser-remote-1.png)
...
![Pumpkin Controller access error in browser tools](/images/2023/pmpkn-ctrl-netlify-03.png)
...
![Pumpkin Controller web app hosted remotely](/images/2023/pumpkin-controller-browser-remote-2.png)
...
![Pumpkin Controller web app hosted remotely](/images/2023/pumpkin-controller-browser-remote-3.png)

To apply the settings change, reload the page as shown in the following figure:

![Pumpkin Controller web app hosted remotely](/images/2023/pumpkin-controller-browser-remote-4.png)
...
![Pumpkin Controller web app hosted remotely](/images/2023/pumpkin-controller-browser-remote-5.png)
...
![Android Chrome Security Warning](/images/2023/pumpkin-controller-browser-android-1.png)

Next, the redirection page appears as expected.

![Pumpkin Controller Redirect page](/images/2023/pumpkin-controller-browser-android-2.png)
...
![Pumpkin Controller failure calling API](/images/2023/pumpkin-controller-browser-android-3.png)
...
![Pumpkin Controller failure calling API](/images/2023/pumpkin-controller-browser-android-4.png)
