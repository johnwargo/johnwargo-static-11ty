...
![Bacon Ipsum home page in the browser](/images/2025/arduino-esp32-connect-https-01.png)

In the window that pops up, I clicked the **Connection is secure** option highlighted in the image:

![Browser Certificate and Cookie information](/images/2025/arduino-esp32-connect-https-02.png)

In the window that appears, I clicked the external link next to **Certificate is valid** highlighted in the image:

![Browser Certificate Options](/images/2025/arduino-esp32-connect-https-03.png)

A dialog appears that displays general information about the certificate. 

![Certificate Viewer](/images/2025/arduino-esp32-connect-https-04.png)
...
![Certificate Hierarchy Details in Chrome](/images/2025/arduino-esp32-connect-https-05.png)
...
![Certificate export dialog](/images/2025/arduino-esp32-connect-https-06.png)
...
![Cert2Arduino App main page](/images/2025/arduino-esp32-connect-https-07.png)

When you save the file, the file name should already be populated with the variable name you specified.

![Chrome's Save Dialog](/images/2025/arduino-esp32-connect-https-08.png)
...
![Arduino IDE showing project files as tabs](/images/2025/arduino-esp32-connect-https-09.png)
