...
![Pycharm Launch Dialog](/images/2025/unihiker-pycharm-00.png)
...
![Pycharm New Project dialog](/images/2025/unihiker-pycharm-01.png)
...
![PyCharm IDE with a new project opened](/images/2025/unihiker-pycharm-02.png)
...
![PyCharm Deployment menu](/images/2025/unihiker-pycharm-03.png)

Click the **+** in the upper left corner of the dialog to create a new deployment configuration. 

![PyCharm Deployment Dialog with new Deployment highlighted](/images/2025/unihiker-pycharm-04.png)
...
![PyCharm Create New Server Dialog](/images/2025/unihiker-pycharm-05.png)
...
![PyCharm Deployment Configuration](/images/2025/unihiker-pycharm-06.png)

In the **SSH Configurations** dialog that appears, click the **+** button to create a new connection.

![PyCharm SSH Configuration Dialog](/images/2025/unihiker-pycharm-07.png)
...
![PyCharm SSH Configuration Settings](/images/2025/unihiker-pycharm-08.png)
...
![PyCharm Deployment Configuration with an SSH Configuration configured](/images/2025/unihiker-pycharm-09.png)

On the dialog's **Mappings** tab, set the **Deployment path** to `/`

![PyCharm Deployment Configuration with an SSH Configuration configured](/images/2025/unihiker-pycharm-10.png)
...
![PyCharm Deployment Menu](/images/2025/unihiker-pycharm-11.png)
...
![An image of a UniHiker device with a new Python program loaded](/images/2025/unihiker-pycharm-12.jpg)
