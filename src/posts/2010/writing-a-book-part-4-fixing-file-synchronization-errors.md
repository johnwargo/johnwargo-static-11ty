...
Well, I was reading O'Reilly's [Windows Vista Annoyances: Tips, Secrets, and Hacks](https://amazon.com/gp/product/0596527624){target="_blank"} at the time and came across a reference to a product from [Creative Element](https://creativelement.com/){target="_blank"} called 'Power Tools'. They had a little utility that would allow me to easily change the date and time for a set of selected files. In an excited frenzy, I downloaded the tools, installed them and went to work.
...
<img src="/images/2010/powertools2.png" alt="PowerTools" />
Figure 1
