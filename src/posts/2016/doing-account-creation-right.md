...
1.  Very few web form developers use the (no longer) new HTML input types ([https://w3schools.com/html/html_form_input_types.asp](https://w3schools.com/html/html_form_input_types.asp){target="_blank"}) like email, date, time, url, and so on.
...
<img src="src/images/2016/Account-Creation-Form-Flows.png" alt="Registration Process Flows" />
...
<img src="src/images/2016/account-creation-form.png" alt="MongoDB Cloud Registration Form" />
