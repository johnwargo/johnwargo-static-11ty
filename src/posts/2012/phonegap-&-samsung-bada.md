...
While working on [PhoneGap Essentials](https://www.phonegapessentials.com), I got a chance to work with some mobile device platforms I’d not worked with before.  I did some work with webOS, but as soon as I got ready to write the chapter on webOS development for PhoneGap, HP announced it was killing the platform and the PhoneGap team added support for Windows Phone development. So, I whacked the webOS chapter and cheerfully replaced it with one on Windows Phone.
...
 ![](/images/2012/phonegap-bada-1.png)
