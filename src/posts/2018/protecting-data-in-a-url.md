...
A while back, I created a [remote garage door opener](https://github.com/johnwargo/garage-controller-particle-simple) project using the [Particle platform](https://www.particle.io/){target="_blank"}.
